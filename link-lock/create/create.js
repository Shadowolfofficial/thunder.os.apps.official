...
async function onEncrypt() {
  ...
  const encrypted = await generateFragment(url, password, hint, useRandomSalt,
      useRandomIv);
  const output = `https://shadowolfofficial.github.io/thunder.os.apps.official/link-lock/#${encrypted}`;

  document.querySelector("#output").value = output;
  highlight("output");

  // Adjust "Hidden Bookmark" link
  document.querySelector("#bookmark").href = `https://shadowolfofficial.github.io/thunder.os.apps.official/link-lock/hidden/#${encrypted}`;
